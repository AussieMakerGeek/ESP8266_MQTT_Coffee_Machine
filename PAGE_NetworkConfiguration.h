...
<tr><td align="right">Hostname:</td><td><input type="text" id="hostname" name="hostname" value=""></td></tr>
...
void send_network_configuration_html()
{
	...
	if (server.args() > 0 )  // Save Settings
	{
      ...
      if (server.argName(i) == "hostname") config.hostname =    urldecode(server.arg(i)); 
